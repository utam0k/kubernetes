...
type KubeletConfiguration struct {
	...
	// On non-linux such as windows, only nil is allowed.
	// On cgroup v1 linux, the value set is ignored and always true.
	// On cgroup v2 linux, nil, true and false are allowed. The default value is false.
	// +optional
